...
public class MultipleEndpointsTest extends NoAppWebsocketTestingBase {
    ...
    @Test
    public void t01_onlyOneControllerCanManageAGivenEndpoint() throws Exception {
        ...
        WebsocketClientWriter writer = websocket("/ws1").disableSslCertificateErrors().connect(client);
        ...
        try {
            ...
            WebsocketClientWriter writer2 = websocket("/ws2").disableSslCertificateErrors().connect(client2);
            fail();
        } catch (Exception ex) {
        }
        ...
        WebsocketClientWriter writer1b = websocket("/ws1").disableSslCertificateErrors().connect(client1b);
    ...
    @Test
    public void t02_controller2CanReuseEndpointIdWhenClosedController1() throws Exception {
        ...
        peerIdToUse[0] = "peer1";
        WebsocketClientTest client = new WebsocketClientTest();
        WebsocketClientWriter writer = websocket("/ws1").disableSslCertificateErrors().ping(0).connect(client);
        assertNotNull(writer);
        ...
        try {
            ...
            @SuppressWarnings("unused")
            WebsocketClientWriter writer2 = websocket("/ws2").disableSslCertificateErrors().ping(0).connect(client2);
            fail();
        } catch (Exception ex) {
        }
        ...
        //==========================================
        // Client #1 isn't connected anymore but has received the
        // closed event.
        //==========================================
    ...
    @Test
    public void t03_multipleEndpointsReceiveMessages() throws Exception {
        ...
        WebsocketClientWriter writer1a = websocket("/ws").disableSslCertificateErrors().connect(client1a);
        assertNotNull(writer1a);

        endpointIdToUse[0] = "endpoint1";
        peerIdToUse[0] = "peer1b";
        WebsocketClientTest client1b = new WebsocketClientTest();
        WebsocketClientWriter writer1b = websocket("/ws").disableSslCertificateErrors().connect(client1b);
        assertNotNull(writer1b);

        endpointIdToUse[0] = "endpoint2";
        peerIdToUse[0] = "peer2a";
        WebsocketClientTest client2a = new WebsocketClientTest();
        WebsocketClientWriter writer2a = websocket("/ws").disableSslCertificateErrors().connect(client2a);
        ...
        WebsocketClientWriter writer3a = websocket("/ws").disableSslCertificateErrors().connect(client3a);
