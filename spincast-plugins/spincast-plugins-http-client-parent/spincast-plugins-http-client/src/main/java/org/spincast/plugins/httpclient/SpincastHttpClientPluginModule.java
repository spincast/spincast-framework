 ...
 */
public class SpincastHttpClientPluginModule extends SpincastGuiceModuleBase {

    public SpincastHttpClientPluginModule() {
        super();
    }

    public SpincastHttpClientPluginModule(Class<? extends RequestContext<?>> requestContextImplementationClass,
