 ...
 */
public class SpincastProcessUtilsPlugin extends SpincastPluginBase {

    public static final String PLUGIN_ID = SpincastProcessUtilsPlugin.class.getName();
    ...
    protected Module getPluginModule() {
        return new SpincastProcessUtilsPluginModule();
    }
