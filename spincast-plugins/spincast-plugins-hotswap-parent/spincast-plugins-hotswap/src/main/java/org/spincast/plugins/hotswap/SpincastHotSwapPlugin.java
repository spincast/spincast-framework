 ...
 */
public class SpincastHotSwapPlugin extends SpincastPluginBase {

    public static final String PLUGIN_ID = SpincastHotSwapPlugin.class.getName();
    ...
    protected Module getPluginModule() {
        return new SpincastHotSwapPluginModule();
    }
