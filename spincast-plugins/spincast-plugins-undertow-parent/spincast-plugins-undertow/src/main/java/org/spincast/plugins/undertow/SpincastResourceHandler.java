 ...
 */
public class SpincastResourceHandler extends ResourceHandler implements ISpincastResourceHandler {
    ...
    @AssistedInject
    public SpincastResourceHandler(@Assisted ResourceManager resourceManager,
                                   @Assisted IStaticResource<?> staticResource,
