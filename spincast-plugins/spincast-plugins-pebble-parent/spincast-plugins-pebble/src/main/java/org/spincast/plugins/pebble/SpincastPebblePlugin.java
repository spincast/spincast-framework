...
public class SpincastPebblePlugin extends SpincastPluginBase {

    public static final String PLUGIN_ID = SpincastPebblePlugin.class.getName();
    ...
    protected Module getPluginModule() {
        return new SpincastPebblePluginModule();
    }
